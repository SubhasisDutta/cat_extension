...
// Cat assets: personality phrases + the source-of-truth SVG.
// Mirrors chrome-extension/cat.js. The SVG markup is identical so both
// platforms render the exact same fat orange cat.
...
object CatArt {
    ...
    fun phraseForSecond(sec: Int): String {
        return PHRASES[abs(sec) % PHRASES.size]
    }

    // Identical to the JS svgMarkup() output. Android renders this via
    // androidx.compose Canvas / a WebView in the overlay (PR #2).
    fun svgMarkup(): String = """
